export default [
  ...
  },
  {
    ...
    desc: "Oscar Under The Bridge is a recycle sculpture Thomas Dambo made as a part of the larger project \"Forgotten Giants\". The project consists of 6 large sculptures made in the outskirts of Copenhagen. Common for all sculptures is that they are made solely from local scrapwood and recycled materials, and made in a hidden beautiful location. This way it invites the viewers to go on a treasure hunt, not only to see the sculptures, but also to discover hidden gems in nature.\n\nOscar under the bridge is made from scrapwood from a torn down watermill and broken pallets from local industries. He is named after an artist from Chile who came to visit Thomas and help him in his work during the time that Thomas and his team was building the sculpture.",
    region: {
      latitude: 55.601398,
      longitude: 12.372434,
      latitudeDelta: 0.10022,
